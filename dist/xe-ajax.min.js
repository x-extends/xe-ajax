...
var H=ad(F);var f=ad(I);var t=ad(N);var i=ad(p);var W=ak(X);var Z=ak(F);var g=ak(I);var z=ak(N);var ae=ak(p);var L=E;var ag="3.1.3";var P={doAll:s,ajax:O,fetchGet:u,getJSON:W,fetchPost:H,postJSON:Z,fetchPut:f,putJSON:g,fetchPatch:t,patchJSON:z,fetchDelete:i,deleteJSON:ae,jsonp:q,setup:m,serialize:h,interceptors:T,version:ag};function aj(an){A(an,function(ap,ao){c[ao]=w(ap)?function(){var aq=ap.apply(c.$context,arguments);ah(c);return aq}:ap})}function ac(an){an.install(c)}aj(P);c.use=ac;c.mixin=aj;c.AjaxController=L;return c}));