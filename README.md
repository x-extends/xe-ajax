...
XEAjax 一个开源且不依赖于任何框架，基于 Promise API 的请求函数；支持 xhr、fetch、jsonp 以及 mock，更高效、简洁的 API、轻封装、高扩展。
...
``` shell
<script src="https://cdn.jsdelivr.net/npm/xe-ajax@3.1.6/dist/xe-ajax.js"></script>
```
### unpkg 获取最新版本
[点击浏览](https://unpkg.com/xe-ajax@3.1.6/)已发布的所有 npm 包源码
``` shell
<script src="https://unpkg.com/xe-ajax@3.1.6/dist/xe-ajax.js"></script>
```
